...
struct StringConstants {
    ...
    static let email_exists = "Email is already exists"
    ...
    static let or_login_with = "Or login with"
    ...
    static let or_register_with = "Or register with"

    
    //MARK:- ChangePasswordVC
    //=======================
    static let Reset_Password = "RESET PASSWORD"
    static let Please_Enter_New_Password = "Please enter the new password"
    ...
    static let Choose_from_gallery = "Choose from_gallery"
